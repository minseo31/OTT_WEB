import {
  LoginDataType,
  SignupCompleteDataType,
  SignupData1Type,
  SignupData2Type,
  SignupData3Type,
} from "../type/data/LoginData";
...
// 가입하기 1단계 데이터
export const signupData1: SignupData1Type = {
  level: "1/3단계",
  title: "가입하기",
  ples: [
...
// 가입하기 2단계(멤버쉽 선택) 데이터 =
export const signupData2: SignupData2Type = {
  level: "2/3단계",
  title: "멤버쉽 선택",
  btn_text: "선택하기",
  membership_data: [
...
// 가입하기 3단계(결제카드 등록하기) 데이터
export const signupData3: SignupData3Type = {
  level: "3/3단계",
  title: "결제 카드 등록하기",
  ples: [
...
// 가입완료 데이터
export const signupCompleteData: SignupCompleteDataType = {
  title: "가입완료",
